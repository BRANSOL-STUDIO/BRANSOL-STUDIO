...
export const TEAM: TeamMember[] = [
  {
    ...
    bio: "Leads BRANSOL's creative output across brand identity, digital design, and campaign. Ensures every commission is grounded in strategy and delivered with senior craft — from first concept to final asset.",
